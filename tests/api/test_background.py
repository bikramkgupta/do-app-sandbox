...
class TestBackgroundProcess:
    ...
    def test_list_processes(self, api_url, auth_headers, cleanup_processes):
        ...
        # List processes
        list_response = httpx.get(f"{api_url}/api/processes", headers=auth_headers, timeout=10.0)
    ...
    def test_process_status_running(self, api_url, auth_headers, cleanup_processes):
        ...
        # Check status
        status_response = httpx.get(f"{api_url}/api/processes/{pid}", headers=auth_headers, timeout=10.0)
    ...
    def test_get_process_logs(self, api_url, auth_headers, cleanup_processes):
        ...
        # Get logs
        logs_response = httpx.get(f"{api_url}/api/processes/{pid}/logs", headers=auth_headers, timeout=10.0)
    ...
    def test_get_process_logs_tail(self, api_url, auth_headers, cleanup_processes):
        ...
        # Get last 2 lines
        logs_response = httpx.get(f"{api_url}/api/processes/{pid}/logs?tail=2", headers=auth_headers, timeout=10.0)
    ...
    def test_kill_process(self, api_url, auth_headers):
        ...
        # Kill it
        kill_response = httpx.post(f"{api_url}/api/processes/{pid}/kill", json={}, headers=auth_headers, timeout=10.0)
