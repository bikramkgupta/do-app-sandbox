...
class WorkloadGenerator:
                ...
                if category_dir.exists():
                    for program_name in programs:
                        ...
                        if program_path.exists():
                            self._program_cache[key].append(
                                ProgramSpec(
                                    name=program_name,
                                    path=program_path,
                                    category=category,
    ...
    def get_all_programs(self, image: ImageType | None = None) -> list[ProgramSpec]:
...
def create_workload_generator(programs_dir: Path | None = None) -> WorkloadGenerator:
