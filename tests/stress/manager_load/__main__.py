...
from .workload_generator import create_workload_generator
...
Examples:
  ...
  python -m tests.stress.manager_load --scenario full_stress

  # Dry run (no real sandboxes)
  python -m tests.stress.manager_load --scenario quick_validation --dry-run

  # List available scenarios
  python -m tests.stress.manager_load --list-scenarios
        """,
    )
