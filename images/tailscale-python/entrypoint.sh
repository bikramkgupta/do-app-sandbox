#!/bin/bash
# Entrypoint script for Python + Tailscale Sandbox container
# Starts Tailscale (userspace mode), health server, and keeps container alive

set -e

echo "Tailscale Python Sandbox starting..."
...
if [ -z "$TS_HOSTNAME" ]; then
    TS_HOSTNAME="sandbox-python-$(hostname | cut -c1-8)"
fi
...
echo ""
echo "============================================"
echo "  Tailscale Python Sandbox Ready!"
echo "============================================"
